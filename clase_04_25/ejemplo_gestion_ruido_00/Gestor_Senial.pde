...
// Emiliano Causa 2011-2015 v2.2
// actualizado al 4/3/2015
//--------------------------------------
/*
...
class GestorSenial {
  ...
  GestorSenial( float factorAmortiguacion_ ) {
    this( "", 0, 100, 200, factorAmortiguacion_, 0.5, 50, 3 );
  }
  //-------------------------------------------
  ...
  GestorSenial( float minimo_, float maximo_, float factorAmortiguacion_ ) {
    this( "", minimo_, maximo_, 200, factorAmortiguacion_, 0.5, 50, 3 );
  }
  //-------------------------------------------
  ...
  void setFiltro( float valor ){
    factorAmortiguacion = valor;
  }  
  //-------------------------------------------
}
// ------------------------------------------------------------------------------------------------------
